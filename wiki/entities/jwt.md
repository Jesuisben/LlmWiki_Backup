...
- 단계 9에서는 기존 대칭키 JWT 기준선 위에 RSA key pair 생성·Secret 주입·private-key 서명/public-key 검증 snippet을 제시한다. 생성된 key·독립 Java source·실제 token·검증 log가 없으므로 RS256 runtime 적용 완료로 확정하지 않는다.
