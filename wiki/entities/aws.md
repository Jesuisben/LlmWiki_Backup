...
- [[summaries/2026-05-middle-project-cicd-passwordless-guide|단계 9 중간 프로젝트]]: VPC·EC2·database·object storage·DNS·certificate·ALB와 별도 인증 server EC2를 하나의 적용 순서로 조립했다. 이는 guide와 embedded snippet의 학습 이력이며 실제 resource export·상태·비용·응답은 없다.
