...
- [[summaries/2026-05-08-aws-rds-resource-cleanup|2026-05-08]]: ping/ICMP, Nginx, Spring Boot jar, RDS MySQL/JDBC, 자원 정리.
...
- [[summaries/2026-05-13-terraform-s3-file-upload|2026-05-13]]: Terraform으로 VPC·Subnet·EC2 같은 인프라를 코드화하고, S3 bucket 파일과 RDS MySQL 상품 데이터를 분리.
