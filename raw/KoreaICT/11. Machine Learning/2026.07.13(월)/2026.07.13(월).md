...
plt.rc('font', family='Malgun Gothic')  # 한글 폰트 설정 (Malgun Gothic)plt.rcParams['axes.unicode_minus'] = False  # 마이너스 기호가 깨지지 않도록 설정  
...
# 입력되는 이미지  
# channel : 흑백 이미지는 1, 컬러 이미지는 3image_size = (150, 150, 3) # width, height, channel  
