...
dataIn = '../dataIn/'
dataOut = '../dataOut/'
filename= dataIn + '/softMaxEx01.csv'
...
imagefilename = dataOut + 'softMaxEx01_01.png'
...
plt.legend()
imagefilename = dataOut + 'softMaxEx01_02.png'
plt.savefig(imagefilename)
print(imagefilename + ' 파일 저장됨')
...
for idx in range(len(x_test)):
    ...
    for idx in range(len(_H)):
        sublist.append(_H[idx])
...
csvfilename=dataOut + 'softMaxCsv.csv'
