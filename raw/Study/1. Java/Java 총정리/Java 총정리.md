...
String, Scanner, random같은 참조 타입(Reference/Class)은 타입을 표현하면서 기능도 가지고 있음)
...
int result = int plus5(int x){return x + 5;}
이런 느낌인데 x에 3이 들어간 형태인데
